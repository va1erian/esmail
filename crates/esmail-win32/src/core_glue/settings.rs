...
impl Default for Settings {
    fn default() -> Self {
        Settings { theme: ThemeChoice::System, remote_images: false, close_to_tray: true }
    }
}
...
mod tests {
    ...
    fn saved_settings_read_back_the_same() {
        ...
        let settings = Settings { theme: ThemeChoice::Dark, remote_images: true, close_to_tray: false };
